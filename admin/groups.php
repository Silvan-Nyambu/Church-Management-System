...
<head>
    ...
    <script type="text/javascript">
        ...
        {
            if(confirm('Sure to delete group?'))
            {
                window.location.href='groups.php?delete_id='+id;
            }
        }
    </script>
...
<body id="admin_panel">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive content_divs" id="div_to_print">
                        ...
                        <h3 align="center"><b>All Groups</b></h3><br>
                        ...
                        $count_data = mysqli_num_rows($run_grps);
                        ...
                        while ($row = mysqli_fetch_array($run_grps)) //fetch the rows
                        {

                        $i++;
                            
                        $id=$row['group_id']; //id to select the record to delete

                        echo "<tr>";
                        echo "<td>".$i."</td>";
                        echo "<td>".$row['group_name']."</td>
                              <td class='dontprint'><a href='edit_group.php?edit=$id' title='Edit'><button type='button' class='btn btn-primary btn-xs'><span class='glyphicon glyphicon-edit'></span> Edit</button></a></td> 
    ...
    $del_grp = "DELETE FROM groups WHERE group_id='$id'";  // execute the delete statement

    $run_del_grp = mysqli_query($connection, $del_grp); 

    if ($run_del_grp) // check if delete is successful
    {
