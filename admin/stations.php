...
<head>
    ...
    <script type="text/javascript">
        ...
        {
            if(confirm('Sure to delete station?'))
            {
...
<body id="admin_panel">
                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive content_divs" id="div_to_print">
                        ...
                        echo "<td>".$row['station_name']."</td>
                              <td class='dontprint'><a href='edit_station.php?edit=$id' title='Edit'><button type='button' class='btn btn-primary btn-xs'><span class='glyphicon glyphicon-edit'></span> Edit</button></a></td> 
                    ...
                    <div class="col-sm-12 text-center" id="print_button">
                        ...
                        ?>
                        <a href="index.php?option=Add_Station" class="btn btn-primary btn-sm pull-right">Add Station</a>
                    </div>
    ...
    $del = "DELETE FROM stations WHERE station_id='$id'";  // execute the delete statement

    $run_del = mysqli_query($connection, $del); 

    if ($run_del) // check if delete is successful
    {
