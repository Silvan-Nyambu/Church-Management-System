...
<body id="admin_panel">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive content_divs" id="div_to_print">
                        ...
                        <h3 align="center"><b>Manage Events</b></h3><br>
                        ...
                        echo "<td>".$row['event_date']."</td>
                              ...
                              <td class='dontprint'><a href='edit_event.php?edit=$id' title='Edit'><button type='button' class='btn btn-primary btn-xs'><span class='glyphicon glyphicon-edit'></span> Edit</button></a></td> 
    ...
    $del_member = "DELETE FROM events WHERE event_id='$id'";  // execute the delete statement
