                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive" id="div_to_print">
                        ...
                        if(isset($_GET['edit'])){
                            ...
                            $get_details = "select * from stations where station_id='$id'";
                        ...
                        if(isset($_POST['post_data'])){
                            ...
                            $newstation_name=$_POST['station_name'];

                            $update = "update stations set station_name='$newstation_name' where station_id='$update_id'";

                            $run_update = mysqli_query($connection, $update);

                            if($run_update) //confirm the group details were inserted into table
                            {
                                $message = "<p style='color: green;'>Station details updated successfully!</p>";
                            }
                            else{
                        ...
                        <h3 align="center"><b>Edit Station Details</b></h3><br>
                        ...
                        <div class="col-sm-5"> 
                        <input type="text" class="form-control" id="name" name="station_name" value="<?php echo "$station_name"; ?>" required="" pattern="[A-Za-z].{2,}" title="Can only contain letters and minimum of 3 characters">
                        </div>
                        </div>
                        <div class="form-group"> 
                        <div class="col-sm-offset-4 col-sm-8">
                        <input type="submit" value=" Save" name="post_data" class="btn btn-primary">
                        <a href="stations.php" class="btn btn-link" title="Back"> Back</a>
                        </div>
                        </div>
                        <div class="form-group">
