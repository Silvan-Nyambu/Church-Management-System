...
<head>
    ...
    <script type="text/javascript">
        function delete_id(id)
        {
            ...
            {
                window.location.href='view_station.php?delete_id='+id;
            }
        }
    </script>
                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive content_divs" id="div_to_print">
                        ...
                        if(isset($_GET['view'])){
                            ...
                            echo "<h3 align='center'><b> $station Out Station</b></h3><br>";

                            $get_members = "select * from members where station='$station'";
