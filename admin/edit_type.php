                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive" id="div_to_print">
                        ...
                        if(isset($_GET['edit'])){
                            ...
                            $get_details = "select * from contribution_types where id='$id'";
                        ...
                        if(isset($_POST['post_data'])){
                            ...
                            $newcontribution_name=$_POST['contribution_name'];

                            //check if entry already exists
                            $check_data = "select contribution_name from contribution_types where contribution_name ='$newcontribution_name'";
                            ...
                            $update = "update contribution_types set contribution_name='$newcontribution_name' where id='$update_id'";

                            $run_update = mysqli_query($connection, $update);

                            if($run_update) //confirm the details were inserted into table
                            {
                                $message = "<p style='color: green;'>Category details updated successfully!</p>";
                            }
                            else{
                        ...
                        <h3 align="center"><b>Edit Category Details</b></h3><br>
                        ...
                        <div class="col-sm-5"> 
                        <input type="text" class="form-control" id="name" name="contribution_name" autofocus="" required="" value="<?php echo "$contribution_name"; ?>" pattern="[A-Za-z].{2,}" title="Can only contain letters and minimum of 3 characters">
                        </div>
                        </div>
                        <div class="form-group"> 
                        <div class="col-sm-offset-4 col-sm-8">
                        <input type="submit" value=" Save" name="post_data" class="btn btn-primary">
                        <a href="contribution_types.php" class="btn btn-link" title="Back"> Back</a>
                        </div>
                        </div>
                        <div class="form-group">
