                ...
                <div class="row">
                    <div class="col-sm-12 table-responsive" id="div_to_print">
                        ...
                        if(isset($_GET['edit'])){
                            ...
                            $get_details = "select * from groups where group_id='$id'";
                        ...
                        if(isset($_POST['post_data'])){
                            ...
                            $update_group = "update groups set group_name='$newgroup_name' where group_id='$update_id'";

                            $run_update_group = mysqli_query($connection, $update_group);

                            if($run_update_group) //confirm the group details were inserted into table
                            {
                        ...
                        <div class="col-sm-5"> 
                        <input type="text" class="form-control" id="name" name="group_name" value="<?php echo "$group_name"; ?>" required="" pattern="[A-Za-z].{2,}" title="Can only contain letters and minimum of 3 characters">
                        </div>
                        </div>
                        <div class="form-group"> 
                        <div class="col-sm-offset-4 col-sm-8">
                        <input type="submit" value=" Save" name="post_data" class="btn btn-primary">
                        <a href="groups.php" class="btn btn-link" title="Back"> Back</a>
                        </div>
                        </div>
                        <div class="form-group">
